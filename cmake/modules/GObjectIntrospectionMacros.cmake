...
macro(gir_add_introspections introspections_girs)
  ...
  foreach(gir IN LISTS ${introspections_girs})
    ...
    set(_gir_namespace "")
    set(foo "${_gir_name}_NAMESPACE")
    if(DEFINED ${foo})
      set(_gir_namespace "${${foo}}")
    endif()
    ...
    set(_gir_version "")
    set(foo "${_gir_name}_VERSION")
    if(DEFINED ${foo})
      set(_gir_version "${${foo}}")
    endif()
    ...
    set(_gir_program "")
    set(foo "${_gir_name}_PROGRAM")
    if(DEFINED ${foo})
      set(_gir_program "${${foo}}")
    endif()
    ...
    set(foo "${_gir_name}_SCANNERFLAGS")
    if(DEFINED ${foo})
      set(_gir_scannerflags "${${foo}}")
    endif()

    # _FILES
    set(_gir_files "")
    set(foo "${_gir_name}_FILES")
    if(DEFINED ${foo})
      set(_gir_files "${${foo}}")
    else()
    ...
    add_custom_command(
      COMMAND ${GObjectIntrospection_COMPILER}
              #${GObjectIntrospection_COMPILER_ARGS} TODO Needed?
              --includedir=.
